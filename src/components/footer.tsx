        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-1">
              ...
              {/* Buy Me a Coffee - tertiary/support style */}
              <div className="pt-3 border-t border-neutral-800/50">
                <p className="text-[10px] text-neutral-600 uppercase tracking-wider mb-2">Support the work</p>
                <a
                  href="https://www.buymeacoffee.com/domalbano3b"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-2.5 py-1 border border-neutral-700 hover:border-neutral-500 text-neutral-500 hover:text-neutral-300 text-xs rounded transition-colors"
                >
