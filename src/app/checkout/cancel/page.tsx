        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
            <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-lg p-8 text-center">
                ...
                <div className="space-y-3">
                    <Link
                        href="/pricing"
                        className="block px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors"
                    >
                        Back to Pricing
                    </Link>
                    <button
                    ...
                    <Link
                        href="/contact"
                        className="block px-4 py-3 text-blue-400 hover:text-blue-300 font-medium"
                    >
                        Contact Support
                    </Link>
                </div>
